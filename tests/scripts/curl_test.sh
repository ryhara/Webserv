...
command_list=(
	...
	"curl $option http://localhost$port/loop.sh"
	"curl $option -X POST http://localhost$port/loop.py"
	"curl $option http://localhost$port/test.rb"
	"curl $option http://localhost$port/calc.py?value1=2&operator=add&value2=5"
	"curl $option -X POST http://localhost$port/calc.py -d value1=2&operator=add&value2=5"
	...
	"curl $option -X DELETE http://localhost$port"
